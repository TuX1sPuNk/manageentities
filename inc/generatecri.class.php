...
class PluginManageentitiesGenerateCRI extends CommonGLPI {
   ...
   function showWizard($ticket, $entities) {
      ...
      PluginManageentitiesEntity::showManageentitiesHeader(__('Generation Intervention report', 'manageentities'));
              ...
              if (taskCount === undefined) {
               ...
               $('#tab-tasks').show();
                ...
                if (description == '' || begin == ''  || userIdTech == 0 || end === undefined  && duration == 0) {
                    alert (__(\"Content, user, end and begin date are mandatory for a task !\", \"manageentities\"));                           
              } else if (end <= begin) {
